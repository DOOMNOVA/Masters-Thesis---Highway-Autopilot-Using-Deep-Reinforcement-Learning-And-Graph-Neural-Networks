...
if __name__ == "__main__":
    ...
    ego_graph_data = create_egocentric_unidirec_tensor_dynamic(obs)
    
    
    actor = Actor_GNN(envs,ego_graph_data,device)
    
    actor_eval = load_model(model_path="SAC_GNN_final_kinda/UNIGRAPH_FINAL/unigraph/sac_gat_uni20231011-140805.pt",actor_network=actor)
    ...
    for episode in trange(1, desc="Test episodes"):
        ...
        while not (done or truncated):
            ...
            #reward_logs["Lane change reward"] += lane_change_reward
    ...
    #TO DO
    # save the date for plotting different graphs with wandb