...
from graph_generator import create_egocentric_unidirec_tensor_dynamic
#import traceback
...
from utils_gnn import check_param_device, save_model_uni
#import pygame
...
if __name__ == "__main__":
    ...
    ego_graph_data_cuda = create_egocentric_unidirec_tensor_dynamic(obs).to(device)
    ...
    for global_step in range(args.total_timesteps):
        ...
        print("infos_2: ",infos)
        next_ego_graph_data_cuda = create_egocentric_unidirec_tensor_dynamic(next_obs).to(device)
        ...
        if truncated and "terminal_observation" in infos.keys():
            ...
            next_ego_graph_data_cuda = create_egocentric_unidirec_tensor_dynamic(real_next_obs).to(device)
        ...
        # ego_graph_data = create_egocentric_unidirec_tensor_dynamic(vehicle_node_attribute_matrix)
        # ego_graph_data_cuda = ego_graph_data.cuda()
