...
from utils_gnn import save_model_expl,  check_param_device
#import pygame
import os 
...
if __name__ == "__main__":
    ...
    ego_graph_data_cuda = create_whole_ego_bigraph_tensor_dynamic(obs).to(device)
    ...
    for global_step in range(args.total_timesteps):
        ...
        print("infos_2: ",infos)
        next_ego_graph_data_cuda = create_whole_ego_bigraph_tensor_dynamic(next_obs).to(device)
        ...
        if truncated and "terminal_observation" in infos.keys():
            ...
            next_ego_graph_data_cuda = create_whole_ego_bigraph_tensor_dynamic(real_next_obs).to(device)
        ...
        # ego_graph_data = create_whole_ego_bigraph_tensor_dynamic(vehicle_node_attribute_matrix)
        # ego_graph_data_cuda = ego_graph_data.cuda()
