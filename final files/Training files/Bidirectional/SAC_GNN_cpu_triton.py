...
class SoftGATv2Network(nn.Module):
    ...
    def __init__(self,env,graph_data,device,num_heads=8,dropout=0.3):
        ...
        self.conv2 = GATv2Conv(in_channels= -1 ,out_channels=2*num_heads*self.input_dim,heads=num_heads,dropout=self.dropout,edge_dim=edge_dim,add_self_loops=False)
        ...
        self.dense = nn.Sequential(nn.Linear(4*num_heads*self.input_dim,output_dim_row),nn.Dropout(dropout),
